            ...
            <Card className="bg-gradient-to-br from-black/80 to-gray-900/80 border-purple-500/30 backdrop-blur-sm shadow-2xl shadow-purple-500/20 overflow-hidden">
              <CardContent className="p-6">
                ...
                <div className="mt-4 flex items-center space-x-2 bg-gray-800 rounded-lg p-3">
                  <Input 
                    placeholder="Pregunta sobre recetas, ingredientes, técnicas..." 
          ...
          <div className="space-y-8">
            <div className="space-y-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-xl mb-2">Recetas y Cocina</h3>
                  <p className="text-gray-300">
                    Recetas tradicionales, técnicas de cocción, combinaciones de ingredientes y consejos culinarios profesionales.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-xl mb-2">Alergias y Dietas</h3>
                  <p className="text-gray-300">
                    Información sobre alergias alimentarias, dietas especiales, sustitutos de ingredientes y opciones saludables.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h3 className="text-white font-bold text-xl mb-2">Consejos Generales</h3>
                  <p className="text-gray-300">
                    Conservación de alimentos, presentación de platos, recomendaciones de vinos y tips de servicio.
                  </p>
                </div>
              </div>
            </div>
